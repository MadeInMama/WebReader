...
namespace WebReader.Migrations
{
    ...
    [Migration("20260529193439_add_settings_to_scheduled_task")]
    partial class add_settings_to_scheduled_task
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebReader.Models.Entities.ScheduledTask", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("HaveToStartAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("WebReader.Models.Entities.ScheduledTaskConfig", b =>
                {
                    ...
                    b.Property<JsonDocument>("DefaultSettings")
                        .IsRequired()
                        .HasColumnType("jsonb");
